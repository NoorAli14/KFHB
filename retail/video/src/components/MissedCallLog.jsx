...
class MissedCallLog extends React.Component {
    ...
    getCallLog(token) {
        ...
        axios.get(window._env_.REACT_APP_BASE_URL + "/chat/calls", {
            params: {
                status: 0, page, size: itemPerPage
    ...
    render() {
        let { buttonDisabled, missedcallLog, isLoading, pageSize, itemPerPage, totalItem, totalPage, startPage, activePage } = this.state;
