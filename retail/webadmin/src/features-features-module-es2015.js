...
const routes = [
    ...
    {
        path: 'ent',
        loadChildren: () => __webpack_require__.e(/*! import() | entitlement-entitlement-module */ "entitlement-entitlement-module").then(__webpack_require__.bind(null, /*! ./entitlement/entitlement.module */ "./src/app/features/entitlement/entitlement.module.ts")).then(m => m.EntitlementModule)
    },
    {
        path: 'calender',
        loadChildren: () => __webpack_require__.e(/*! import() | calender-calender-module */ "calender-calender-module").then(__webpack_require__.bind(null, /*! ./calender/calender.module */ "./src/app/features/calender/calender.module.ts")).then(m => m.CalenderModule)
    },
    {
        path: 'setting',
        loadChildren: () => Promise.all(/*! import() | setting-setting-module */[__webpack_require__.e("default~setting-setting-module~views-request-details-request-details-module"), __webpack_require__.e("common"), __webpack_require__.e("setting-setting-module")]).then(__webpack_require__.bind(null, /*! ./setting/setting.module */ "./src/app/features/setting/setting.module.ts")).then(m => m.SettingModule)
    },
    {
        path: 'error',
        loadChildren: () => __webpack_require__.e(/*! import() | error-error-module */ "error-error-module").then(__webpack_require__.bind(null, /*! ./error/error.module */ "./src/app/features/error/error.module.ts")).then(m => m.ErrorModule)
    },
    {
        path: 'refferals',
        loadChildren: () => __webpack_require__.e(/*! import() | referrals-referrals-module */ "referrals-referrals-module").then(__webpack_require__.bind(null, /*! ./referrals/referrals.module */ "./src/app/features/referrals/referrals.module.ts")).then(m => m.ReferralsModule)
    },
    {
        path: 'req',
        loadChildren: () => __webpack_require__.e(/*! import() | service-requests-service-requests-module */ "service-requests-service-requests-module").then(__webpack_require__.bind(null, /*! ./service-requests/service-requests.module */ "./src/app/features/service-requests/service-requests.module.ts")).then(m => m.ServiceRequestModule)
    },
    {
