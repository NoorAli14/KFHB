...
export const MESSAGES = {
    ...
    INVITE_RESENT:()=> `An invitation link has been sent to provided user email? ${getRandomNumber()}`,
    INVALID_CREDENTIAL:()=> `Username or password is incorrect. ${getRandomNumber()}`,
    ...
    INVITATION_SENT:()=> `User created successfully. An invitation link has been sent to provided user email. ${getRandomNumber()}`,
