/* [Notification Service] - create migration table */
CREATE TABLE [RUBIX_NOTIFICATION_MIGRATIONS] ([id] int identity(1,1) not null primary key, [name] nvarchar(255), [batch] int, [migration_time] datetime2 default CURRENT_TIMESTAMP);


/* [Notification Service] [20200825203734] - 20200825203734_create_otp_table.ts */
CREATE TABLE [NTF_OTP] ([id] uniqueidentifier default NEWID(), [user_id] uniqueidentifier not null, [tenent_id] uniqueidentifier not null, [delivery_mode] nvarchar(255) not null, [mobile_no] nvarchar(255), [email] nvarchar(255), [otp_code] nvarchar(255) not null, [status] nvarchar(255) not null, [created_on] datetime2 default CURRENT_TIMESTAMP, [created_by] nvarchar(255) not null, [updated_on] datetime2 default CURRENT_TIMESTAMP, [updated_by] nvarchar(255), CONSTRAINT [NTF_OTP_pkey] PRIMARY KEY ([id]));

/* [Notification Service] Add 20200825203734_create_otp_table.ts to migration table */
insert into [RUBIX_NOTIFICATION_MIGRATIONS] ([batch], [name]) values (1, '20200825203734_create_otp_table.ts');
...
/* [Notification Service] Add 20200827122822_create_push_notification_table.ts to migration table */
insert into [RUBIX_NOTIFICATION_MIGRATIONS] ([batch], [name]) values (1, '20200827122822_create_push_notification_table.ts');
...
/* [Notification Service] Add 20200901173616_update_push_notification_table.ts to migration table */
insert into [RUBIX_NOTIFICATION_MIGRATIONS] ([batch], [name]) values (1, '20200901173616_update_push_notification_table.ts');
...
/* [Notification Service] Add 20200901195705_remove_token_from_push_notification_table.ts to migration table */
insert into [RUBIX_NOTIFICATION_MIGRATIONS] ([batch], [name]) values (1, '20200901195705_remove_token_from_push_notification_table.ts');
...
/* [Notification Service] Add 20200910183650_alter_tenant_id_in_otp.ts to migration table */
insert into [RUBIX_NOTIFICATION_MIGRATIONS] ([batch], [name]) values (1, '20200910183650_alter_tenant_id_in_otp.ts');
...
/* [Notification Service] Add 20200913113017_alter_otp_table.ts to migration table */
insert into [RUBIX_NOTIFICATION_MIGRATIONS] ([batch], [name]) values (1, '20200913113017_alter_otp_table.ts');
