/* [Compliance Service] - create migration table */
CREATE TABLE [RUBIX_COMPLIANCE_MIGRATIONS] ([id] int identity(1,1) not null primary key, [name] nvarchar(255), [batch] int, [migration_time] datetime2 default CURRENT_TIMESTAMP);
...
/* [Compliance Service] Add 20200720103133_create_cmp_template_table.ts to migration table */
insert into [RUBIX_COMPLIANCE_MIGRATIONS] ([batch], [name]) values (1, '20200720103133_create_cmp_template_table.ts');
...
/* [Compliance Service] Add 20200720103554_create_cmp_section_table.ts to migration table */
insert into [RUBIX_COMPLIANCE_MIGRATIONS] ([batch], [name]) values (1, '20200720103554_create_cmp_section_table.ts');
...
/* [Compliance Service] Add 20200720103559_create_cmp_question_table.ts to migration table */
insert into [RUBIX_COMPLIANCE_MIGRATIONS] ([batch], [name]) values (1, '20200720103559_create_cmp_question_table.ts');
...
/* [Compliance Service] Add 20200720103604_create_cmp_option_table.ts to migration table */
insert into [RUBIX_COMPLIANCE_MIGRATIONS] ([batch], [name]) values (1, '20200720103604_create_cmp_option_table.ts');
...
/* [Compliance Service] Add 20200720103727_create_cmp_template_responses_table.ts to migration table */
insert into [RUBIX_COMPLIANCE_MIGRATIONS] ([batch], [name]) values (1, '20200720103727_create_cmp_template_responses_table.ts');
...
/* [Compliance Service] Add 20200819120131_add_userid_in_template_response.ts to migration table */
insert into [RUBIX_COMPLIANCE_MIGRATIONS] ([batch], [name]) values (1, '20200819120131_add_userid_in_template_response.ts');
...
/* [Compliance Service] Add 20200908191218_cmp_aml_request.ts to migration table */
insert into [RUBIX_COMPLIANCE_MIGRATIONS] ([batch], [name]) values (1, '20200908191218_cmp_aml_request.ts');
...
/* [Compliance Service] Add 20200908191238_cmp_aml_response.ts to migration table */
insert into [RUBIX_COMPLIANCE_MIGRATIONS] ([batch], [name]) values (1, '20200908191238_cmp_aml_response.ts');
