...
export const CUSTOMER_LAST_STEPS = {
  ...
  RBX_ONB_STEP_NATIONAL_ID_FRONT_UPLOADED:
    'RBX_ONB_STEP_NATIONAL_ID_FRONT_UPLOADED',
  RBX_ONB_STEP_NATIONAL_ID_BACK_UPLOADED:
    'RBX_ONB_STEP_NATIONAL_ID_BACK_UPLOADED',
  RBX_ONB_STEP_PASSPORT_UPLOADED: 'RBX_ONB_STEP_PASSPORT_UPLOADED',
  RBX_ONB_STEP_DRIVING_LICENCE_UPLOADED:
    'RBX_ONB_STEP_DRIVING_LICENCE_UPLOADED',
  RBX_ONB_STEP_NATIONAL_ID_FRONT_PROCESSED:
    'RBX_ONB_STEP_NATIONAL_ID_FRONT_PROCESSED',
  RBX_ONB_STEP_NATIONAL_ID_BACK_PROCESSED:
    'RBX_ONB_STEP_NATIONAL_ID_BACK_PROCESSED',
  RBX_ONB_STEP_PASSPORT_PROCESSED: 'RBX_ONB_STEP_PASSPORT_PROCESSED',
  RBX_ONB_STEP_DRIVING_LICENCE_PROCESSED:
    'RBX_ONB_STEP_DRIVING_LICENCE_PROCESSED',
  ...
  RBX_ONB_STEP_AML_SCREENING_SUCCESSFUL:
    'RBX_ONB_STEP_AML_SCREENING_SUCCESSFUL',
  ...
  RBX_ONB_STEP_AGENT_VERIFICATION_SCHEDULED:
    'RBX_ONB_STEP_AGENT_VERIFICATION_SCHEDULED',
  RBX_ONB_STEP_AGENT_VERIFICATION_SUCCESSFUL:
    'RBX_ONB_STEP_AGENT_VERIFICATION_SUCCESSFUL',
  RBX_ONB_STEP_AGENT_VERIFICATION_FAILED:
    'RBX_ONB_STEP_AGENT_VERIFICATION_FAILED',
};
