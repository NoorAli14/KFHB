...
import { AuthGuard, CurrentUser, CUSTOMER_LAST_STEPS, AML_STATUSES, PermissionsGuard } from '@common/index';
...
export class AmlController {
  constructor(private readonly amlService: AmlService, private readonly customerService: CustomersService) {}
