/* [Rubix | Entitlement Service] - create migration table */
CREATE TABLE [RUBIX_ENTITLEMENT_MIGRATIONS] ([id] int identity(1,1) not null primary key, [name] nvarchar(255), [batch] int, [migration_time] datetime2 default CURRENT_TIMESTAMP);


/* [Rubix | Entitlement Service] [20200625222904] - 20200625222904_create_users_table.ts */
...
/* [Rubix | Entitlement Service] Add 20200625222904_create_users_table.ts to migration table */
insert into [RUBIX_ENTITLEMENT_MIGRATIONS] ([batch], [name]) values (1, '20200625222904_create_users_table.ts');


/* [Rubix | Entitlement Service] [20200719230156] - 20200719230156_create_role_table.ts */
...
/* [Rubix | Entitlement Service] Add 20200719230156_create_role_table.ts to migration table */
insert into [RUBIX_ENTITLEMENT_MIGRATIONS] ([batch], [name]) values (1, '20200719230156_create_role_table.ts');


/* [Rubix | Entitlement Service] [20200719230642] - 20200719230642_create_user_role_table.ts */
...
/* [Rubix | Entitlement Service] Add 20200719230642_create_user_role_table.ts to migration table */
insert into [RUBIX_ENTITLEMENT_MIGRATIONS] ([batch], [name]) values (1, '20200719230642_create_user_role_table.ts');


/* [Rubix | Entitlement Service] [20200719231448] - 20200719231448_create_module_table.ts */
...
/* [Rubix | Entitlement Service] Add 20200719231448_create_module_table.ts to migration table */
insert into [RUBIX_ENTITLEMENT_MIGRATIONS] ([batch], [name]) values (1, '20200719231448_create_module_table.ts');


/* [Rubix | Entitlement Service] [20200719232143] - 20200719232143_create_permission_table.ts */
...
/* [Rubix | Entitlement Service] Add 20200719232143_create_permission_table.ts to migration table */
insert into [RUBIX_ENTITLEMENT_MIGRATIONS] ([batch], [name]) values (1, '20200719232143_create_permission_table.ts');


/* [Rubix | Entitlement Service] [20200819042239] - 20200819042239_create_working_week_table.ts */
...
/* [Rubix | Entitlement Service] Add 20200819042239_create_working_week_table.ts to migration table */
insert into [RUBIX_ENTITLEMENT_MIGRATIONS] ([batch], [name]) values (1, '20200819042239_create_working_week_table.ts');


/* [Rubix | Entitlement Service] [20200824173103] - 20200824173103_create_holiday_table.ts */
...
/* [Rubix | Entitlement Service] Add 20200824173103_create_holiday_table.ts to migration table */
insert into [RUBIX_ENTITLEMENT_MIGRATIONS] ([batch], [name]) values (1, '20200824173103_create_holiday_table.ts');


/* [Rubix | Entitlement Service] [20200824175601] - 20200824175601_create_leave_type_table.ts */
...
/* [Rubix | Entitlement Service] Add 20200824175601_create_leave_type_table.ts to migration table */
insert into [RUBIX_ENTITLEMENT_MIGRATIONS] ([batch], [name]) values (1, '20200824175601_create_leave_type_table.ts');


/* [Rubix | Entitlement Service] [20200824175602] - 20200824175602_create_leave_table.ts */
...
/* [Rubix | Entitlement Service] Add 20200824175602_create_leave_table.ts to migration table */
insert into [RUBIX_ENTITLEMENT_MIGRATIONS] ([batch], [name]) values (1, '20200824175602_create_leave_table.ts');


/* [Rubix | Entitlement Service] [20200826201822] - 20200826201822_create_module_permission_table.ts */
...
/* [Rubix | Entitlement Service] Add 20200826201822_create_module_permission_table.ts to migration table */
insert into [RUBIX_ENTITLEMENT_MIGRATIONS] ([batch], [name]) values (1, '20200826201822_create_module_permission_table.ts');


/* [Rubix | Entitlement Service] [20200826201941] - 20200826201941_create_module_permission_role_table.ts */
...
/* [Rubix | Entitlement Service] Add 20200826201941_create_module_permission_role_table.ts to migration table */
insert into [RUBIX_ENTITLEMENT_MIGRATIONS] ([batch], [name]) values (1, '20200826201941_create_module_permission_role_table.ts');


/* [Rubix | Entitlement Service] [20201004171753] - 20201004171753_alter_users_table_remove_username_column.ts */
...
/* [Rubix | Entitlement Service] Add 20201004171753_alter_users_table_remove_username_column.ts to migration table */
insert into [RUBIX_ENTITLEMENT_MIGRATIONS] ([batch], [name]) values (1, '20201004171753_alter_users_table_remove_username_column.ts');


/* [Rubix | Entitlement Service] [20201004172044] - 20201004172044_alter_module_table_add_slug_column.ts */
ALTER TABLE [ENT_MODULE] ADD [slug] nvarchar(255);
CREATE INDEX [ENT_MODULE_SLUG_INDEX] ON [ENT_MODULE] ([slug]);

/* [Rubix | Entitlement Service] Add 20201004172044_alter_module_table_add_slug_column.ts to migration table */
insert into [RUBIX_ENTITLEMENT_MIGRATIONS] ([batch], [name]) values (1, '20201004172044_alter_module_table_add_slug_column.ts');
