...
import { X_CORRELATION_KEY, X_USER_ID, X_TENANT_ID, X_ENTITY_ID } from './constants';
...
export const formattedHeader = (req: Request, user_id?: string, entity_id?: string): IHEADER => {
  ...
  if (entity_id) headers[X_ENTITY_ID] = entity_id;
  return headers;
};